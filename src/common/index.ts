...
export default class Common {
  ...
  static forCustomChain(
    ...
    if (baseChain === "youchain") {
        standardChainParams.chainId = standardChainParams.networkId;
        if (customChainParams.networkId) {
            customChainParams.chainId = customChainParams.networkId;
        }
    }
    return new Common(
      {
